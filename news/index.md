...
- Fixed spacing between decked heads on grouped summary tabs (fixes
  [\#29](https://github.com/ccsarapas/lighthouse.codebook/issues/29)).

### Internal

- Added `cb_create_spss_impl()` and `cb_write_impl()` for SPSS extension
  command interface / future-proofing.
...
- [`cb_create_spss()`](https://ccsarapas.github.io/lighthouse.codebook/reference/cb_create_spss.md)
  no longer throws an error when `.user_missing = NULL`.
