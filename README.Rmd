...
Excel workbook, including a data dictionary and variable summaries. It incorporates external 
...
knitr::include_graphics("vignettes/img/overview.png")
```
...
knitr::include_graphics("vignettes/img/numeric.png")
```
...
knitr::include_graphics("vignettes/img/categorical.png")
```
...
knitr::include_graphics("vignettes/img/text.png")
```
